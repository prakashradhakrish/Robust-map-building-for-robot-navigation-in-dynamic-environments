#!/usr/bin/env python
'''
Code created to use the MASKRCNN implementation from https://github.com/matterport/Mask_RCNN.git
and publish mask segmenatation ouput as ros topic
'''
import os
import threading
try: 
...
class MaskRCNNNode(object):
    ...
    def run(self):
        ...
        vis_pub = rospy.Publisher('/mask_rcnn/mask', Image, queue_size=1)
        #status_pub = rospy.Publisher('~mask_rcnn_ready', Bool, queue_size=1) # input to the image publisher node
