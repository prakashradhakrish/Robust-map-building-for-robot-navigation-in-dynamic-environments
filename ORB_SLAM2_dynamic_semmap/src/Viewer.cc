...
void Viewer::Run()
{
    ...
    pangolin::Var<bool> menuShowDynamicDensity("menu.Show Dynamic density", true, true);
    pangolin::Var<bool> menuShowStaticPoints("menu.Show Static Points", true, true);
    pangolin::Var<bool> menuShowNonDynPoints("menu.Show Non Dyn Points", true, true);
    pangolin::Var<bool> menuShowDynPoints("menu.Show Dyn Points", true, true);
    pangolin::Var<bool> menuCuboid("menu.Cuboid of car", true, true);
    ...
    while(1)
    {
        ...
        if(menuShowPoints)
            mpMapDrawer->DrawMapPoints(menuShowCurrentPoints,
                                        menuShowDynamicDensity,
                                        menuShowStaticPoints,
                                        menuShowNonDynPoints,
                                        menuShowDynPoints,
                                        Twc,
                                        menuCuboid);
