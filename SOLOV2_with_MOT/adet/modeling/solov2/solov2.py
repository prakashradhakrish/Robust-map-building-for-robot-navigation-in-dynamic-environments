...
class SOLOv2(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.scale_ranges = cfg.MODEL.SOLOV2.FPN_SCALE_RANGES # ((1, 96), (48, 192), (96, 384), (192, 768), (384, 2048))
        self.strides = cfg.MODEL.SOLOV2.FPN_INSTANCE_STRIDES # [8, 8, 16, 32, 32]
        self.sigma = cfg.MODEL.SOLOV2.SIGMA # 0.2
        # Instance parameters.
        ...
        self.instance_in_channels = cfg.MODEL.SOLOV2.INSTANCE_IN_CHANNELS  # 256.
        ...
        self.max_before_nms = cfg.MODEL.SOLOV2.NMS_PRE             #  500
        self.score_threshold = cfg.MODEL.SOLOV2.SCORE_THR          #  0.1
        self.update_threshold = cfg.MODEL.SOLOV2.UPDATE_THR        #  0.05
        self.mask_threshold = cfg.MODEL.SOLOV2.MASK_THR            #  0.5
        self.max_per_img = cfg.MODEL.SOLOV2.MAX_PER_IMG            #  100
        self.nms_kernel = cfg.MODEL.SOLOV2.NMS_KERNEL              # guassian
        self.nms_sigma = cfg.MODEL.SOLOV2.NMS_SIGMA                #  2
        self.nms_type = cfg.MODEL.SOLOV2.NMS_TYPE                  # matrix
        ...
        # loss
        self.ins_loss_weight = cfg.MODEL.SOLOV2.LOSS.DICE_WEIGHT   # 3
        self.focal_loss_alpha = cfg.MODEL.SOLOV2.LOSS.FOCAL_ALPHA  # 0.25
        self.focal_loss_gamma = cfg.MODEL.SOLOV2.LOSS.FOCAL_GAMMA  # 2.0
        self.focal_loss_weight = cfg.MODEL.SOLOV2.LOSS.FOCAL_WEIGHT # 1.0
    ...
    def forward(self, batched_inputs):
        ...
        #print("hi",ins_features[0].shape,ins_features[1].shape,ins_features[2].shape,ins_features[3].shape,ins_features[4].shape)
        ...
        if self.training:
            ...
            results,mask_pred = self.inference(cate_pred, kernel_pred, mask_pred, images.image_sizes, batched_inputs)
            return results,mask_pred
    ...
    def inference(self, pred_cates, pred_kernels, pred_masks, cur_sizes, images):
        ...
        for img_idx in range(len(images)):
            ...
            # inference for single image. // input dimension [(3872,80),(3872,256),([1, 256, 56, 56]),imagesize,(h,w)]
            result,mask_pred = self.inference_single_image(pred_cate, pred_kernel, pred_mask,cur_sizes[img_idx], ori_size)
            results.append({"instances": result})
            results.append({"features": feature_FPN})
            results.append({"maskfeatures": mask_pred})
        return results,mask_pred
    ...
    def inference_single_image(
        ...
        cate_scores = cate_preds[inds] #shape will be equal to the number of correct prediction
        ...
        if len(cate_scores) == 0:
            ...
            return results,seg_preds

        # cate_labels & kernel_preds
        inds = inds.nonzero() # will ouput [x,y] x is fc number and y is prediction 
        cate_labels = inds[:, 1]
...
class SOLOv2InsHead(nn.Module):
    def __init__(self, cfg, input_shape: List[ShapeSpec]):
        ...
        for head in head_configs:
            tower = []
            num_convs, use_deformable, use_coord = head_configs[head] # [[4,False,False],[4,False,True]]
        ...
        prior_prob = cfg.MODEL.SOLOV2.PRIOR_PROB # 0.01
